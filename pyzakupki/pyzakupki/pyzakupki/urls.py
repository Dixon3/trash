...
urlpatterns = patterns('',
    ...
    url(r'^customers/$','customers.views.index',name='customers'),      
    url(r'^customers/(?P<regnum>\d+)/$','customers.views.customer',name='customers'),
    url(r'^customers/(?P<regnum>\d+)/contracts/$','customers.views.customer_contracts',name='customers_contracts'),
